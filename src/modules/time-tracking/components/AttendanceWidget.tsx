...
export function AttendanceWidget({ overview }: { overview: any[] }) {
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="show"
            className="relative group overflow-hidden bg-surface border border-border rounded-[2.5rem] p-6 sm:p-10 shadow-2xl h-full"
        >
            ...
            <div className="relative z-10 flex flex-col h-full">
                <div className="flex justify-between items-start mb-10">
                    <motion.div variants={{ hidden: { opacity: 0, x: -20 }, show: { opacity: 1, x: 0 } }}>
                        ...
                        <h2 className="text-2xl sm:text-4xl font-[1000] text-text-primary uppercase tracking-tighter italic">Fluxo <span className="text-slate-400">Tempo Real</span></h2>
                    </motion.div>

                    <motion.div variants={{ hidden: { opacity: 0, x: 20 }, show: { opacity: 1, x: 0 } }} className="text-right">
                        <div className="text-3xl sm:text-5xl font-[1000] text-text-primary tracking-tighter leading-none mb-1 italic">
                            {mounted ? time.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' }) : '--:--'}
                        </div>
                ...
                <div className="flex flex-col xl:flex-row items-center gap-8 sm:gap-16 flex-1">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 flex items-center justify-center flex-col z-20">
                            <motion.span
                                ...
                                className="text-5xl sm:text-7xl font-[1000] text-text-primary tracking-tighter leading-none italic"
                            >
