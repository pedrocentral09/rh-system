                            ...
                            >
                                <div className="flex items-center gap-5">
                                    <div className="h-16 w-16 bg-white/5 text-slate-400 rounded-[22px] flex items-center justify-center transition-all group-hover:bg-blue-500/20 group-hover:text-blue-400">
                                        {doc.type === 'CONTRATO' || doc.type === 'TERMO' ? <Stamp className="h-7 w-7" /> : <User className="h-7 w-7" />}
                                    </div>
                                    <div>
                                        <h4 className="font-[1000] text-white leading-none mb-2 uppercase text-xs tracking-widest">{doc.fileName}</h4>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className={cn(
                                                ...
                                                doc.status === 'APPROVED' || doc.status === 'VALIDATED' ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-brand-orange"
                                            )} />
                                            <span className="text-[10px] text-slate-500 font-[1000] uppercase tracking-tighter">
                                                {doc.status === 'PENDING' ? 'Pendente' : 'Validado'}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2">
                                    <a
                                        ...
                                        className="h-12 w-12 rounded-2xl bg-white/5 text-slate-400 hover:text-white hover:bg-white/10 transition-all border border-white/5 flex items-center justify-center"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="h-12 w-12 rounded-2xl bg-brand-blue/10 text-blue-400 hover:text-white hover:bg-brand-blue transition-all border border-blue-400/20 flex items-center justify-center"
                                    >
